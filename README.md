...
Statistics is the branch of mathematics that deals with collecting, organizing, analyzing, interpreting, and presenting data to support decision-making.
...
It involves methods for summarizing, organizing, and describing data in a meaningful way using numbers, tables, and visualizations.

### ✨ Common Techniques:
### 📌 Measures of Central Tendency
These are used to identify the center of a data distribution.
...
| Box Plot       | To detect spread, skewness, and outliers      |
| Pie Chart      | To represent proportions of categorical data  |
| Bar Graph      | To compare quantities of categories           |
...
- **Shape**: Bell curve, symmetric about the mean.
...
- **Types :**
1. Positive skew (Right-skewed): Tail is on the right. Mean > Median.
2. Negative skew (Left-skewed): Tail is on the left. Mean < Median.
...
### ✅ Use case:
> "To estimate what percentage of all users will click an ad, based on a sample of 1,000 users."
